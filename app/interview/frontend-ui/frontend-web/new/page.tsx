    ...
    try {
      ...
      const res = await fetch('/api/interview/create', {
        ...
        body: JSON.stringify({
          ...
          category,
          content: fullContent,
          topicPath: 'frontend-ui/frontend-web',
        }),
      });
      ...
      if (res.ok && data.success) {
        router.push('/interview/frontend-ui/frontend-web/' + data.slug);
      } else {
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <Link href="/interview/frontend-ui/frontend-web" style={{ color: '#3b82f6', textDecoration: 'none', fontWeight: 500 }}>
          ← Back to Topic
        </Link>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
          <Link href="/interview/frontend-ui/frontend-web" style={{ padding: '0.6rem 1.25rem', borderRadius: '6px', border: '1px solid rgba(125,125,125,0.3)', color: 'inherit', textDecoration: 'none' }}>
            Cancel
          </Link>
