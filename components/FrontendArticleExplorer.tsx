        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium transition-all cursor-pointer border ${
                isSelected
            ...
            <div className="flex flex-col space-y-1.5">
              {list.map((article) => (
                <Link
                  ...
                  className="group flex items-center justify-between px-4 py-3 rounded-xl border border-[var(--notion-border)] bg-[var(--notion-card-bg)] hover:bg-[var(--notion-hover)] hover:border-[var(--notion-border-strong)] transition-all"
                >
                  <div className="flex items-center gap-3.5 min-w-0 pr-2">
                    ...
                    <span className="text-sm md:text-base font-medium text-[var(--notion-text-primary)] group-hover:underline truncate">
                      {article.title}
                    </span>
                  </div>
                  <ChevronRight className="w-4 h-4 text-[var(--notion-text-muted)] group-hover:text-[var(--notion-text-primary)] shrink-0 transition-transform group-hover:translate-x-0.5" />
                </Link>
              ))}
            </div>
          </div>
